...
export const translations = {
  en: {
    ...
    achievements: {
      ...
      subtitle: 'Track your achievements and unlock new badges',
      ...
      noBadgesYet: 'You don\'t have any badges yet. Keep learning to earn some!',
      points: 'points',
    ...
    auth: {
      login: {
        title: 'Login',
        subtitle: 'Sign in to your account to access your courses',
        email: 'Email address',
      ...
      register: {
        ...
        passwordInvalid: 'Password does not meet security requirements',
    ...
    offline: {
      ...
      message: 'It seems you have no internet connection. Check your connection and try again.',
      retry: 'Retry',
      offlineContent: 'Some content you have already viewed may be available offline.',
      tips: {
        title: 'Tips for using Erythix Campus offline',
        download: 'Download your courses to access them offline',
        notes: 'Your notes and bookmarks are saved locally',
        sync: 'Your progress will be synced when you reconnect',
      },
    },
    // Admin
    admin: {
      title: 'Administration',
      subtitle: 'Manage your training platform',
      ...
      stats: {
        ...
        perCourse: 'Enrollments per course',
      },
      ...
      newUsers: 'New users',
      newUsersSubtitle: 'Latest registrations on the platform',
      ...
      quickActions: {
        ...
        manageCoursesDesc: 'Create, edit, publish',
        manageUsers: 'Manage users',
        manageUsersDesc: 'Roles, permissions, accounts',
        reports: 'Reports',
    ...
    instructor: {
      ...
      noCourses: {
        ...
        message: 'Start by creating your first course',
      },
    },
    // Academies
    academies: {
    ...
    labs: {
      ...
      subtitle: 'Put your knowledge into practice in real environments.',
    ...
    repositories: {
      ...
      subtitle: 'Work on real projects with Git.',
      gitIntegration: 'Git Integration',
      connectGitHub: 'Connect GitHub',
      connectDescription: 'Link your GitHub account to fork project templates, submit assignments, and track your progress.',
      ...
      noProjectsDesc: 'Start a course to get your first project assignment.',
      exploreCourses: 'Explore Courses',
      projectTemplates: 'Project Templates',
      templatesDesc: 'Fork these templates to start your assignments.',
      templates: 'Project Templates',
      fork: 'Fork',
      view: 'View',
      submit: 'Submit',
      workflowTitle: 'How It Works',
      step1Title: '1. Fork the Template',
      step1Desc: 'Create your own copy of the project template to work on.',
      step2Title: '2. Code & Commit',
      step2Desc: 'Develop your solution and commit your changes to your repository.',
      step3Title: '3. Submit via PR',
      step3Desc: 'Open a pull request to submit your work for review and grading.',
      ctaTitle: 'Ready to start coding?',
      ctaDescription: 'Explore our courses and get hands-on experience with real-world projects.',
      status: {
      ...
      workflow: {
        step1: 'Fork the template',
        step2: 'Code and commit',
        step3: 'Submit via PR',
      },
    },
  },
  fr: {
    ...
    achievements: {
      ...
      subtitle: 'Suivez vos accomplissements et débloquez de nouveaux badges',
      ...
      noBadgesYet: 'Vous n\'avez pas encore de badge. Continuez votre apprentissage pour en gagner !',
      points: 'points',
    ...
    auth: {
      login: {
        title: 'Connexion',
        subtitle: 'Connectez-vous à votre compte pour accéder à vos cours',
        email: 'Adresse email',
      ...
      register: {
        ...
        subtitle: 'Rejoignez notre plateforme d\'apprentissage',
        firstName: 'Prénom',
        ...
        success: {
          title: 'Compte créé !',
          message: 'Votre compte a été créé avec succès. Redirection vers la page de connexion...',
        },
    ...
    offline: {
      ...
      message: 'Il semble que vous n\'ayez pas de connexion internet. Vérifiez votre connexion et réessayez.',
      retry: 'Réessayer',
      offlineContent: 'Certains contenus que vous avez déjà consultés peuvent être disponibles hors ligne.',
      tips: {
        title: 'Conseils pour utiliser Erythix Campus hors ligne',
        download: 'Téléchargez vos cours pour y accéder hors ligne',
        notes: 'Vos notes et signets sont sauvegardés localement',
        sync: 'Votre progression sera synchronisée à la reconnexion',
      },
    },
    // Admin
    admin: {
      title: 'Administration',
      subtitle: 'Gérez votre plateforme de formation',
      ...
      stats: {
        ...
        perCourse: 'Inscriptions par cours',
      },
      popularCourses: 'Cours populaires',
      viewAll: 'Voir tout',
      enrolled: 'inscrits',
      recentEnrollments: 'Dernières inscriptions',
      newUsers: 'Nouveaux utilisateurs',
      newUsersSubtitle: 'Les derniers inscrits sur la plateforme',
      ...
      quickActions: {
        ...
        manageCoursesDesc: 'Créer, modifier, publier',
        manageUsers: 'Gérer les utilisateurs',
        manageUsersDesc: 'Rôles, permissions, comptes',
        reports: 'Rapports',
        reportsDesc: 'Statistiques et analyses',
      },
    },
    // Instructor
    instructor: {
      ...
      noCourses: {
        ...
        message: 'Commencez par créer votre premier cours',
      },
    },
    // Academies
    academies: {
    ...
    labs: {
      ...
      subtitle: 'Mettez en pratique vos connaissances dans des environnements réels.',
      environments: 'Environnements de travail',
      popularLabs: 'Labs populaires',
      ...
      stats: {
        available: 'Labs disponibles',
        completed: 'Complétés',
        pointsEarned: 'Points gagnés',
        practiceTime: 'Temps pratique',
      },
    },
    // Repositories
    repositories: {
      title: 'Repositories & Projets',
      subtitle: 'Travaillez sur des projets réels avec Git.',
      gitIntegration: 'Intégration Git',
      connectGitHub: 'Connecter GitHub',
      connectDescription: 'Liez votre compte GitHub pour forker des templates de projets, soumettre des devoirs et suivre votre progression.',
      ...
      noProjectsDesc: 'Commencez un cours pour obtenir votre premier devoir de projet.',
      exploreCourses: 'Explorer les cours',
      projectTemplates: 'Templates de projets',
      templatesDesc: 'Forkez ces templates pour démarrer vos devoirs.',
      templates: 'Templates de projets',
      fork: 'Fork',
      view: 'Voir',
      submit: 'Soumettre',
      workflowTitle: 'Comment ça marche',
      step1Title: '1. Forker le template',
      step1Desc: 'Créez votre propre copie du template de projet pour travailler dessus.',
      step2Title: '2. Coder & Commiter',
      step2Desc: 'Développez votre solution et commitez vos modifications dans votre repository.',
      step3Title: '3. Soumettre via PR',
      step3Desc: 'Ouvrez une pull request pour soumettre votre travail pour révision et notation.',
      ctaTitle: 'Prêt à coder ?',
      ctaDescription: 'Explorez nos cours et acquérez une expérience pratique avec des projets réels.',
      status: {
      ...
      workflow: {
        step1: 'Fork le template',
        step2: 'Codez et commitez',
        step3: 'Soumettez via PR',
      },
    },
  },
  de: {
    ...
    achievements: {
      ...
      subtitle: 'Verfolgen Sie Ihre Erfolge und schalten Sie neue Abzeichen frei',
      ...
      badgesToUnlock: 'Freizuschaltende Abzeichen',
      noBadgesYet: 'Sie haben noch keine Abzeichen. Lernen Sie weiter, um welche zu verdienen!',
      points: 'Punkte',
    ...
    auth: {
      login: {
        title: 'Anmeldung',
        subtitle: 'Melden Sie sich an, um auf Ihre Kurse zuzugreifen',
      ...
      register: {
        ...
        subtitle: 'Treten Sie unserer Lernplattform bei',
        firstName: 'Vorname',
        ...
        passwordInvalid: 'Passwort erfüllt nicht die Sicherheitsanforderungen',
        ...
        success: {
          ...
          message: 'Ihr Konto wurde erfolgreich erstellt. Weiterleitung zur Anmeldung...',
        },
    ...
    offline: {
      ...
      message: 'Es scheint, dass Sie keine Internetverbindung haben. Überprüfen Sie Ihre Verbindung und versuchen Sie es erneut.',
      retry: 'Erneut versuchen',
      offlineContent: 'Einige Inhalte, die Sie bereits angesehen haben, sind möglicherweise offline verfügbar.',
      tips: {
        title: 'Tipps für die Nutzung von Erythix Campus offline',
        download: 'Laden Sie Ihre Kurse herunter, um offline darauf zuzugreifen',
        notes: 'Ihre Notizen und Lesezeichen werden lokal gespeichert',
        sync: 'Ihr Fortschritt wird bei der Wiederverbindung synchronisiert',
      },
    },
    // Admin
    admin: {
      title: 'Administration',
      subtitle: 'Verwalten Sie Ihre Schulungsplattform',
      newCourse: 'Neuer Kurs',
      stats: {
        users: 'Benutzer',
        courses: 'Kurse',
        enrollments: 'Einschreibungen',
        avgRate: 'Durchschnittsrate',
        thisWeek: 'diese Woche',
        published: 'Veröffentlichte Kurse',
        perCourse: 'Einschreibungen pro Kurs',
      },
      popularCourses: 'Beliebte Kurse',
      viewAll: 'Alle anzeigen',
      enrolled: 'eingeschrieben',
      recentEnrollments: 'Neueste Einschreibungen',
      newUsers: 'Neue Benutzer',
      newUsersSubtitle: 'Die neuesten Registrierungen auf der Plattform',
      ...
      quickActions: {
        ...
        manageCoursesDesc: 'Erstellen, bearbeiten, veröffentlichen',
        manageUsers: 'Benutzer verwalten',
        manageUsersDesc: 'Rollen, Berechtigungen, Konten',
        reports: 'Berichte',
        reportsDesc: 'Statistiken und Analysen',
      },
    },
    // Instructor
    instructor: {
      title: 'Meine Kurse',
      subtitle: 'Erstellen und verwalten Sie Ihre Kurse',
      createCourse: 'Kurs erstellen',
      stats: {
        created: 'Erstellte Kurse',
      ...
      noCourses: {
        title: 'Keine Kurse erstellt',
        message: 'Beginnen Sie mit der Erstellung Ihres ersten Kurses',
      },
    },
    // Labs
    labs: {
      title: 'Labs & praktische Übungen',
      subtitle: 'Setzen Sie Ihr Wissen in realen Umgebungen in die Praxis um.',
      environments: 'Arbeitsumgebungen',
      popularLabs: 'Beliebte Labs',
      startLab: 'Lab starten',
      viewAllLabs: 'Alle Labs anzeigen',
      available: 'Verfügbar',
    ...
    // Repositories
    repositories: {
      title: 'Repositories & Projekte',
      subtitle: 'Arbeiten Sie an echten Projekten mit Git.',
      gitIntegration: 'Git-Integration',
      connectGitHub: 'GitHub verbinden',
      connectDescription: 'Verknüpfen Sie Ihr GitHub-Konto, um Projektvorlagen zu forken, Aufgaben einzureichen und Ihren Fortschritt zu verfolgen.',
      ...
      noProjectsDesc: 'Beginnen Sie einen Kurs, um Ihre erste Projektaufgabe zu erhalten.',
      exploreCourses: 'Kurse erkunden',
      projectTemplates: 'Projektvorlagen',
      templatesDesc: 'Forken Sie diese Vorlagen, um Ihre Aufgaben zu starten.',
      templates: 'Projektvorlagen',
      fork: 'Fork',
      view: 'Ansehen',
      submit: 'Einreichen',
      workflowTitle: 'So funktioniert es',
      step1Title: '1. Vorlage forken',
      step1Desc: 'Erstellen Sie Ihre eigene Kopie der Projektvorlage zum Arbeiten.',
      step2Title: '2. Coden & Committen',
      step2Desc: 'Entwickeln Sie Ihre Lösung und committen Sie Ihre Änderungen in Ihr Repository.',
      step3Title: '3. Per PR einreichen',
      step3Desc: 'Öffnen Sie einen Pull Request, um Ihre Arbeit zur Überprüfung und Bewertung einzureichen.',
      ctaTitle: 'Bereit zum Coden?',
      ctaDescription: 'Erkunden Sie unsere Kurse und sammeln Sie praktische Erfahrungen mit realen Projekten.',
      status: {
      ...
      workflow: {
        step1: 'Vorlage forken',
        step2: 'Coden und committen',
        step3: 'Per PR einreichen',
      },
    },
    // Academies
    academies: {
  ...
  nl: {
    ...
    achievements: {
      ...
      subtitle: 'Volg uw prestaties en ontgrendel nieuwe badges',
      ...
      noBadgesYet: 'U heeft nog geen badges. Blijf leren om er te verdienen!',
      points: 'punten',
      pointsAccumulated: 'verzamelde punten',
      pointsToNextLevel: 'punten naar volgend niveau',
      categories: {
      ...
      stats: {
        coursesCompleted: 'Voltooide cursussen',
        lessonsCompleted: 'Voltooide lessen',
        quizzesPassed: 'Geslaagde quizzen',
        certificates: 'Certificaten',
      },
    },
    // Common
    ...
    auth: {
      login: {
        title: 'Inloggen',
        subtitle: 'Log in op uw account om toegang te krijgen tot uw cursussen',
        email: 'E-mailadres',
      ...
      register: {
        ...
        subtitle: 'Word lid van ons leerplatform',
        firstName: 'Voornaam',
        ...
        passwordInvalid: 'Wachtwoord voldoet niet aan de beveiligingseisen',
        ...
        success: {
          ...
          message: 'Uw account is succesvol aangemaakt. Doorsturen naar inloggen...',
        },
    ...
    offline: {
      ...
      message: 'Het lijkt erop dat u geen internetverbinding heeft. Controleer uw verbinding en probeer het opnieuw.',
      retry: 'Opnieuw proberen',
      offlineContent: 'Sommige inhoud die u al heeft bekeken, is mogelijk offline beschikbaar.',
      tips: {
        title: 'Tips voor het gebruik van Erythix Campus offline',
        download: 'Download uw cursussen om ze offline te openen',
        notes: 'Uw notities en bladwijzers worden lokaal opgeslagen',
        sync: 'Uw voortgang wordt gesynchroniseerd wanneer u weer verbonden bent',
      },
    },
    // Admin
    admin: {
      title: 'Beheer',
      subtitle: 'Beheer uw trainingsplatform',
      ...
      stats: {
        ...
        thisWeek: 'deze week',
        published: 'Gepubliceerde cursussen',
        perCourse: 'Inschrijvingen per cursus',
      },
      popularCourses: 'Populaire cursussen',
      viewAll: 'Alles bekijken',
      enrolled: 'ingeschreven',
      recentEnrollments: 'Recente inschrijvingen',
      newUsers: 'Nieuwe gebruikers',
      newUsersSubtitle: 'De nieuwste registraties op het platform',
      ...
      quickActions: {
        ...
        manageCoursesDesc: 'Maken, bewerken, publiceren',
        manageUsers: 'Gebruikers beheren',
        manageUsersDesc: 'Rollen, rechten, accounts',
        reports: 'Rapporten',
        reportsDesc: 'Statistieken en analyses',
      },
    },
    // Instructor
    instructor: {
      title: 'Mijn cursussen',
      subtitle: 'Maak en beheer uw cursussen',
      createCourse: 'Cursus maken',
      stats: {
        created: 'Gemaakte cursussen',
      ...
      noCourses: {
        title: 'Geen cursussen gemaakt',
        message: 'Begin met het maken van uw eerste cursus',
      },
    },
    // Labs
    labs: {
      title: 'Labs & praktische oefeningen',
      subtitle: 'Pas uw kennis toe in echte omgevingen.',
      environments: 'Werkomgevingen',
      popularLabs: 'Populaire Labs',
      startLab: 'Start Lab',
      viewAllLabs: 'Alle labs bekijken',
    ...
    // Repositories
    repositories: {
      title: 'Repositories & Projecten',
      subtitle: 'Werk aan echte projecten met Git.',
      gitIntegration: 'Git-integratie',
      connectGitHub: 'GitHub verbinden',
      connectDescription: 'Koppel uw GitHub-account om projectsjablonen te forken, opdrachten in te dienen en uw voortgang te volgen.',
      connectButton: 'Verbinden met GitHub',
      ...
      noProjectsDesc: 'Begin een cursus om uw eerste projectopdracht te krijgen.',
      exploreCourses: 'Cursussen verkennen',
      projectTemplates: 'Projectsjablonen',
      templatesDesc: 'Fork deze sjablonen om uw opdrachten te starten.',
      templates: 'Projectsjablonen',
      fork: 'Fork',
      view: 'Bekijken',
      submit: 'Indienen',
      workflowTitle: 'Hoe het werkt',
      step1Title: '1. Sjabloon forken',
      step1Desc: 'Maak uw eigen kopie van het projectsjabloon om mee te werken.',
      step2Title: '2. Coderen & committen',
      step2Desc: 'Ontwikkel uw oplossing en commit uw wijzigingen naar uw repository.',
      step3Title: '3. Indienen via PR',
      step3Desc: 'Open een pull request om uw werk in te dienen voor review en beoordeling.',
      ctaTitle: 'Klaar om te coderen?',
      ctaDescription: 'Verken onze cursussen en doe praktische ervaring op met echte projecten.',
      status: {
      ...
      workflow: {
        step1: 'Sjabloon forken',
        step2: 'Coderen en committen',
        step3: 'Indienen via PR',
      },
    },
    // Academies
    academies: {
